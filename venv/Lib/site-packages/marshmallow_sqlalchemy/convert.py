...
from sqlalchemy.dialects import ***REMOVED***, mysql, mssql
...
def _***REMOVED***_array_factory(converter, data_type):
...
class ModelConverter:
    ...
    SQLA_TYPE_MAPPING = {
        ...
        sa.JSON: fields.Raw,
        ***REMOVED***.BIT: fields.Integer,
        ***REMOVED***.OID: fields.Integer,
        ***REMOVED***.UUID: fields.UUID,
        ***REMOVED***.MACADDR: fields.String,
        ***REMOVED***.INET: fields.String,
        ***REMOVED***.CIDR: fields.String,
        ***REMOVED***.JSON: fields.Raw,
        ***REMOVED***.JSONB: fields.Raw,
        ***REMOVED***.HSTORE: fields.Raw,
        ***REMOVED***.ARRAY: _***REMOVED***_array_factory,
        ***REMOVED***.MONEY: fields.Decimal,
        ***REMOVED***.DATE: fields.Date,
        ***REMOVED***.TIME: fields.Time,
