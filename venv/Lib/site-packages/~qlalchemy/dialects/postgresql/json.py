...
class JSON(sqltypes.JSON):
    ...
    :class:`_***REMOVED***.JSON` is used automatically whenever the base
    ...
    :meth:`_***REMOVED***.JSON.Comparator.astext`; additionally, to use
    PostgreSQL ``JSONB``, the :class:`_***REMOVED***.JSONB` datatype should
    be used explicitly.
    ...
    * Path index operations returning text (the ``#>>`` operator)::
    ...
    .. versionchanged:: 1.1 :class:`_***REMOVED***.JSON` is now a PostgreSQL-
...
class JSONB(JSON):
    ...
    The :class:`_***REMOVED***.JSONB` type stores arbitrary JSONB format data,
    e.g.::
    ...
    The :class:`_***REMOVED***.JSONB` type includes all operations provided by
    ...
    Like the :class:`_types.JSON` type, the :class:`_***REMOVED***.JSONB`
