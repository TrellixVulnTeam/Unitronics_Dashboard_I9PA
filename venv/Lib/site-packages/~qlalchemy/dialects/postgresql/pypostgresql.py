...
"""
.. dialect:: ***REMOVED***+py***REMOVED***
    :name: py-***REMOVED***
    :dbapi: py***REMOVED***
    :connectstring: ***REMOVED***+py***REMOVED***://user:password@host:port/dbname[?key=value&key=value...]
    :url: https://python.projects.pgfoundry.org/

.. note::

    The py***REMOVED*** dialect is **not tested as part of SQLAlchemy's continuous
    integration** and may have unresolved issues.  The recommended PostgreSQL
    driver is psycopg2.

.. deprecated:: 1.4 The py-***REMOVED*** DBAPI is deprecated and will be removed
...
class PGExecutionContext_py***REMOVED***(PGExecutionContext):
    pass


class PGDialect_py***REMOVED***(PGDialect):
    driver = "py***REMOVED***"
    ...
    execution_ctx_cls = PGExecutionContext_py***REMOVED***
    ...
    @classmethod
    def dbapi(cls):
        from ***REMOVED***.driver import dbapi20

        # TODO update link
        util.warn_deprecated(
            "The py-***REMOVED*** DBAPI is deprecated and will be removed "
            "in a future version. This DBAPI is superseded by the external"
