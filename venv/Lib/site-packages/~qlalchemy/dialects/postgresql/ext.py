...
class aggregate_order_by(expression.ColumnElement):
    ...
    E.g.::
        ...
        from sqlalchemy.dialects.***REMOVED*** import aggregate_order_by
...
class ExcludeConstraint(ColumnCollectionConstraint):
    ...
    __ https://www.***REMOVED***.org/docs/current/static/sql-createtable.html#SQL-CREATETABLE-EXCLUDE
    ...
    create_drop_stringify_dialect = "***REMOVED***"
    ...
    def __init__(self, *elements, **kw):
        ...
        :param ops:
          ...
          :ref:`***REMOVED***_ops <***REMOVED***_operator_classes>`
          ...
          .. seealso::
            ...
            :ref:`***REMOVED***_operator_classes` - general description of how
...
def array_agg(*arg, **kw):
    ...
    return type is :class:`_***REMOVED***.ARRAY` and not
