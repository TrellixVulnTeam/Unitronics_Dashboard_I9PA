...
r"""
.. dialect:: ***REMOVED***+pg8000
    :name: pg8000
    :dbapi: pg8000
    :connectstring: ***REMOVED***+pg8000://user:password@host:port/dbname[?key=value&key=value...]
...
the ``***REMOVED***.conf`` file, which often defaults to ``SQL_ASCII``.
...
passed to :func:`_sa.create_engine` using the ``client_encoding`` parameter::
    ...
    engine = create_engine(
        "***REMOVED***+pg8000://user:pass@host/dbname", client_encoding='utf8')
...
:paramref:`_sa.create_engine.connect_args` dictionary::
    ...
    engine = sa.create_engine(
        "***REMOVED***+pg8000://scott:tiger@192.168.0.199/test",
