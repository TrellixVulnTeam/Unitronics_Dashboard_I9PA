...
r"""
.. dialect:: ***REMOVED***+asyncpg
    :name: asyncpg
    :dbapi: asyncpg
    :connectstring: ***REMOVED***+asyncpg://user:password@host:port/dbname[?key=value&key=value...]
...
:func:`_asyncio.create_async_engine` engine creation function::
    ...
    engine = create_async_engine("***REMOVED***+asyncpg://user:pass@hostname/dbname")
...
in conjunction with :func:`_sa.create_engine`::
    ...
    engine = create_engine("***REMOVED***+asyncpg://user:pass@hostname/dbname?async_fallback=true")
...
argument)::
    ...
    engine = create_async_engine("***REMOVED***+asyncpg://user:pass@hostname/dbname?prepared_statement_cache_size=500")

To disable the prepared statement cache, use a value of zero::

    engine = create_async_engine("***REMOVED***+asyncpg://user:pass@hostname/dbname?prepared_statement_cache_size=0")
...
client using this setting passed to :func:`_asyncio.create_async_engine`::
    ...
    engine = create_async_engine(
        "***REMOVED***+asyncpg://user:password@localhost/tmp",
