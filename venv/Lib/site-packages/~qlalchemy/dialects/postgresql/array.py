...
class array(expression.ClauseList, expression.ColumnElement):
    ...
    This is used to produce ARRAY literals in SQL expressions, e.g.::
        ...
        from sqlalchemy.dialects import ***REMOVED***
        from sqlalchemy import select, func

        stmt = select(array([1,2]) + array([3,4,5]))

        print(stmt.compile(dialect=***REMOVED***.dialect()))
    ...
    .. seealso::
        ...
        :class:`_***REMOVED***.ARRAY`

    """

    __visit_name__ = "array"

    stringify_dialect = "***REMOVED***"
    inherit_cache = True
...
class ARRAY(sqltypes.ARRAY):
    ...
    .. versionchanged:: 1.1 The :class:`_***REMOVED***.ARRAY` type is now
       a subclass of the core :class:`_types.ARRAY` type.

    The :class:`_***REMOVED***.ARRAY` type is constructed in the same way
    ...
    than one dimension::
        ...
        mytable = Table("mytable", metadata,
                Column("data", ***REMOVED***.ARRAY(Integer, dimensions=2))
            )

    The :class:`_***REMOVED***.ARRAY` type provides all operations defined on the
    core :class:`_types.ARRAY` type, including support for "dimensions",
    indexed access, and simple matching such as
    :meth:`.types.ARRAY.Comparator.any` and
    :meth:`.types.ARRAY.Comparator.all`.  :class:`_***REMOVED***.ARRAY`
    class also
    provides PostgreSQL-specific methods for containment operations, including
    :meth:`.***REMOVED***.ARRAY.Comparator.contains`
    :meth:`.***REMOVED***.ARRAY.Comparator.contained_by`, and
    :meth:`.***REMOVED***.ARRAY.Comparator.overlap`, e.g.::

        mytable.c.data.contains([1, 2])

    The :class:`_***REMOVED***.ARRAY` type may not be supported on all
    PostgreSQL DBAPIs; it is currently known to work on psycopg2 only.

    Additionally, the :class:`_***REMOVED***.ARRAY`
    type does not work directly in
    conjunction with the :class:`.ENUM` type.  For a workaround, see the
    special type at :ref:`***REMOVED***_array_of_enum`.

    .. seealso::

        :class:`_types.ARRAY` - base array type

        :class:`_***REMOVED***.array` - produces a literal array value.
