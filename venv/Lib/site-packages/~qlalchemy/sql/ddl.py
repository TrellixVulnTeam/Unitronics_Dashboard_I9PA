...
class DDLElement(roles.DDLRole, Executable, _DDLCompiles):
    ...
    itself an event receiving callable::
        ...
        event.listen(
            users,
            'after_create',
            AddConstraint(constraint).execute_if(dialect='***REMOVED***')
        )
    ...
    def execute_if(self, dialect=None, callable_=None, state=None):
        ...
        Used to provide a wrapper for event listening::
            ...
            event.listen(
                        metadata,
                        'before_create',
                        DDL("my_ddl").execute_if(dialect='***REMOVED***')
                    )
        ...
        :param dialect: May be a string or tuple of strings.
          ...
          executing database dialect::
            ...
            DDL('something').execute_if(dialect='***REMOVED***')

          If a tuple, specifies multiple dialect names::

            DDL('something').execute_if(dialect=('***REMOVED***', 'mysql'))
