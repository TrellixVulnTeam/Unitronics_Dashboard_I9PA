...
class DateTime(_LookupExpressionAdapter, TypeEngine):
    ...
    def _expression_adaptations(self):
        ...
        # Based on
        # https://www.***REMOVED***.org/docs/current/static/functions-datetime.html.
...
class Enum(Emulated, String, SchemaType):
    ...
    .. seealso::
        ...
        :class:`_***REMOVED***.ENUM` - PostgreSQL-specific type,
...
class JSON(Indexable, TypeEngine):
    ...
    .. note::  :class:`_types.JSON`
       ...
       * PostgreSQL - see :class:`sqlalchemy.dialects.***REMOVED***.JSON` and
         :class:`sqlalchemy.dialects.***REMOVED***.JSONB` for backend-specific
         notes
    ...
    * Data casters for specific JSON element types, subsequent to an index
    ...
    :class:`sqlalchemy.dialects.***REMOVED***.JSON` and
    :class:`sqlalchemy.dialects.***REMOVED***.JSONB` which both offer additional
    ...
    **Customizing the JSON Serializer**
    ...
    .. seealso::
        ...
        :class:`sqlalchemy.dialects.***REMOVED***.JSON`

        :class:`sqlalchemy.dialects.***REMOVED***.JSONB`
    ...
    which always resolves to SQL NULL.  E.g.::
        ...
        from sqlalchemy import null
        from sqlalchemy.dialects.***REMOVED*** import JSON
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine):
    ...
    .. note::  This type serves as the basis for all ARRAY operations.
       ...
       :class:`sqlalchemy.dialects.***REMOVED***.ARRAY` type directly when using
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    .. seealso::
        ...
        :class:`sqlalchemy.dialects.***REMOVED***.ARRAY`
    ...
    class Comparator(Indexable.Comparator, Concatenable.Comparator):
        ...
        of this type.  See :class:`.***REMOVED***.ARRAY.Comparator`.
