        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            valid SQLAlchemy expressions or constructs::
                ...
                engine = create_engine(
                    '***REMOVED***://scott:tiger@localhost/mydatabase'
                )
        ...
        **dialect_kw
        ...
        if len(set(columns)) != len(refcolumns):
            if len(set(columns)) != len(columns):
                ...
                # paraphrasing
                # https://www.***REMOVED***.org/docs/current/static/ddl-constraints.html
                raise exc.ArgumentError(
...
class Index(DialectKWArgs, ColumnCollectionMixin, SchemaItem):
    ...
    .. seealso::
        ...
        :ref:`***REMOVED***_indexes` - PostgreSQL-specific options available for
