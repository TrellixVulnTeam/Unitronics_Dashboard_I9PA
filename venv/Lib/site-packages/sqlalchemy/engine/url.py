...
class URL(
    ...
    def update_query_string(self, query_string, append=False):
        ...
        E.g.::
            ...
            >>> url = make_url("***REMOVED***://user:pass@host/dbname")
            >>> url = url.update_query_string("alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt")
            >>> str(url)
            '***REMOVED***://user:pass@host/dbname?alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt'
    ...
    def normalized_query(self):
        ...
        function.  E.g.::
            ...
            >>> from sqlalchemy.engine import make_url
            >>> url = make_url("***REMOVED***://user:pass@host/dbname?alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt")
            >>> url.query
