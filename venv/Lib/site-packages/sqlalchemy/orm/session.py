        ...
        :param binds: A dictionary which may specify any number of
           ...
           described at :meth:`.Session.get_bind`.  Usage looks like::
            ...
            Session = sessionmaker(binds={
                SomeMappedClass: create_engine('***REMOVED***://engine1'),
                SomeDeclarativeBase: create_engine('***REMOVED***://engine2'),
                some_mapper: create_engine('***REMOVED***://engine3'),
                some_table: create_engine('***REMOVED***://engine4'),
                })
...
class sessionmaker(_SessionClassMethods):
    ...
    e.g.::
        ...
        # resources
        engine = create_engine('***REMOVED***://scott:tiger@localhost/')
