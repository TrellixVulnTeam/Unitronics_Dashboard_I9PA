...
class FunctionElement(Executable, ColumnElement, FromClause, Generative):
    ...
    def table_valued(self, *expr, **kw):
        ...
        .. seealso::
            ...
            :ref:`***REMOVED***_table_valued` - in the :ref:`***REMOVED***_toplevel` documentation
    ...
    def column_valued(self, name=None):
        ...
        .. seealso::
            ...
            :ref:`***REMOVED***_column_valued` - in the :ref:`***REMOVED***_toplevel` documentation
...
class array_agg(GenericFunction):
    ...
    .. seealso::
        ...
        :func:`_***REMOVED***.array_agg` - PostgreSQL-specific version that
        returns :class:`_***REMOVED***.ARRAY`, which has PG-specific operators
        added.
