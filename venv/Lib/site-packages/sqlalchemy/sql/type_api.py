...
class TypeEngine(Traversible):
    ...
    def evaluates_none(self):
        ...
        .. seealso::
            ...
            :paramref:`.***REMOVED***.JSON.none_as_null` - PostgreSQL JSON
    ...
    def with_variant(self, type_, dialect_name):
        ...
        :param dialect_name: base name of the dialect which uses
         this type. (i.e. ``'***REMOVED***'``, ``'mysql'``, etc.)
...
class NativeForEmulated(object):
    ...
    def adapt_emulated_to_native(cls, impl, **kw):
        ...
        e.g.: ***REMOVED***.ENUM produces a type given an Enum instance.
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    .. warning::
       ...
       the :class:`_***REMOVED***.JSON` and :class:`_***REMOVED***.JSONB` types;
    ...
    def _unwrapped_dialect_impl(self, dialect):
        ...
        # ***REMOVED***.INTERVAL being the main example
