...
<http://www.***REMOVED***.org/docs/current/static/ddl-schemas.html#DDL-SCHEMAS-PATH>`_.
...
.. versionadded:: 0.9.2 Added the ``***REMOVED***_ignore_search_path``
...
.. seealso::
    ...
    <http://www.***REMOVED***.org/docs/9.0/static/ddl-schemas.html#DDL-SCHEMAS-PATH>`_
...
.. seealso::
    ...
    `INSERT .. ON CONFLICT
    <http://www.***REMOVED***.org/docs/current/static/sql-insert.html#SQL-ON-CONFLICT>`_
...
an index (see
http://www.***REMOVED***.org/docs/8.3/interactive/indexes-opclass.html).
...
http://www.***REMOVED***.org/docs/8.3/static/indexes-types.html). These can be
...
.. seealso::
    ...
    <http://www.***REMOVED***.org/docs/current/static/sql-createtable.html>`_
...
class PGDialect(default.DefaultDialect):
    ...
    def initialize(self, connection):
        ...
        # http://www.***REMOVED***.org/docs/9.3/static/release-9-2.html#AEN116689
    ...
    def get_foreign_keys(
        ...
        **kw
        ...
        FK_SQL = """
          ...
          ORDER BY 1
        """
        # http://www.***REMOVED***.org/docs/9.0/static/sql-createtable.html
        FK_REGEX = re.compile(
    ...
    def _pg_index_any(self, col, compare_to):
        if self.server_version_info < (8, 1):
            # http://www.***REMOVED***.org/message-id/10279.1124395722@sss.pgh.pa.us
