...
@create_db.for_db("***REMOVED***")
def _pg_create_db(cfg, eng, ident):
    template_db = cfg.options.***REMOVED***_templatedb
...
@temp_table_keyword_args.for_db("***REMOVED***")
def _***REMOVED***_temp_table_keyword_args(cfg, eng):
    return {"prefixes": ["TEMPORARY"]}


@set_default_schema_on_connection.for_db("***REMOVED***")
def _***REMOVED***_set_default_schema_on_connection(
...
@drop_all_schema_objects_pre_tables.for_db("***REMOVED***")
...
@drop_all_schema_objects_post_tables.for_db("***REMOVED***")
def drop_all_schema_objects_post_tables(cfg, eng):
    ...
    with eng.begin() as conn:
        for enum in inspector.get_enums("*"):
            conn.execute(
                ***REMOVED***.DropEnumType(
                    ***REMOVED***.ENUM(name=enum["name"], schema=enum["schema"])
                )
            )


@prepare_for_drop_tables.for_db("***REMOVED***")
