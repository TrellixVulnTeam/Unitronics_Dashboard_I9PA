...
class Insert(StandardInsert):
    ...
    The :class:`_***REMOVED***.Insert` object is created using the
    :func:`sqlalchemy.dialects.***REMOVED***.insert` function.
    ...
    def excluded(self):
        ...
        .. tip::  The :attr:`_***REMOVED***.Insert.excluded` attribute is an
        ...
        .. seealso::
            ...
            :ref:`***REMOVED***_insert_on_conflict` - example of how
    ...
    def on_conflict_do_update(
        ...
        :param set\_:
         ...
         .. versionadded:: 1.4 The
            :paramref:`_***REMOVED***.Insert.on_conflict_do_update.set_`
        ...
        .. seealso::
            ...
            :ref:`***REMOVED***_insert_on_conflict`
...
insert = public_factory(
    Insert, ".dialects.***REMOVED***.insert", ".dialects.***REMOVED***.Insert"
)
    ...
    def __init__(self, constraint=None, index_elements=None, index_where=None):
        ...
        if constraint is not None:
            ...
            if isinstance(constraint, util.string_types):
                ...
                index_where = constraint.dialect_options["***REMOVED***"].get(
                    "where"
                )
