...
LEXERS = {
    ...
    'PostgresConsoleLexer': ('pygments.lexers.sql', 'PostgreSQL console (psql)', ('psql', '***REMOVED***-console', '***REMOVED***-console'), (), ('text/x-***REMOVED***-psql',)),
    'PostgresLexer': ('pygments.lexers.sql', 'PostgreSQL SQL dialect', ('***REMOVED***', '***REMOVED***'), (), ('text/x-***REMOVED***',)),
