"""
    ...
    `PostgresLexer`
        ...
        - keywords and data types list parsed from the PG docs (run the
          `_***REMOVED***_builtins` module to update them);
...
from pygments.lexers._***REMOVED***_builtins import KEYWORDS, DATATYPES, \
...
class PostgresBase:
    ...
    def _get_lexer(self, lang):
        if lang.lower() == 'sql':
            return get_lexer_by_name('***REMOVED***', **self.options)
...
class PostgresConsoleLexer(Lexer):
    ...
    aliases = ['psql', '***REMOVED***-console', '***REMOVED***-console']
    mimetypes = ['text/x-***REMOVED***-psql']
