...
class AdminModelConverter(ModelConverterBase):
    ...
    @converts('sqlalchemy.dialects.***REMOVED***.base.INET')
    def conv_PGInet(self, field_args, **extra):
        field_args.setdefault('label', u'IP Address')
        field_args['validators'].append(validators.IPAddress())
        return fields.StringField(**field_args)

    @converts('sqlalchemy.dialects.***REMOVED***.base.MACADDR')
    def conv_PGMacaddr(self, field_args, **extra):
        field_args.setdefault('label', u'MAC Address')
        field_args['validators'].append(validators.MacAddress())
        return fields.StringField(**field_args)

    @converts('sqlalchemy.dialects.***REMOVED***.base.UUID',
    ...
    @converts('sqlalchemy.dialects.***REMOVED***.base.ARRAY',
