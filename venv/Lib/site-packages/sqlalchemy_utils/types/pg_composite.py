...
.. _PostgreSQL composite types:
    https://www.***REMOVED***.org/docs/current/rowtypes.html


Related links:

https://schinckel.net/2014/09/24/using-***REMOVED***-composite-types-in-django/
"""
from collections import namedtuple

import sqlalchemy as sa
from sqlalchemy.dialects.***REMOVED***.psycopg2 import PGDialect_psycopg2
