...
from sqlalchemy.dialects.***REMOVED***.base import ischema_names, PGTypeCompiler
...
class LtreeType(types.Concatenable, types.UserDefinedType, ScalarCoercible):
    ...
    refer to https://www.***REMOVED***.org/docs/current/ltree.html
    ...
    .. note::
        ...
        side. Please visit https://www.***REMOVED***.org/ for details.
    """
    cache_ok = True
