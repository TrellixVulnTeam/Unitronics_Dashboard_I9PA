...
def database_exists(url):
    ...
    exists on the server. ::
        ...
        database_exists('***REMOVED***://***REMOVED***@localhost/name')  #=> False
        create_database('***REMOVED***://***REMOVED***@localhost/name')
        database_exists('***REMOVED***://***REMOVED***@localhost/name')  #=> True

    Supports checking against a constructed URL as well. ::

        engine = create_engine('***REMOVED***://***REMOVED***@localhost/name')
    ...
    engine = None
    try:
        if dialect_name == '***REMOVED***':
            text = "SELECT 1 FROM pg_database WHERE datname='%s'" % database
            for db in (database, '***REMOVED***', 'template1', 'template0', None):
...
def create_database(url, encoding='utf8', template=None):
    ...
    Has full support for mysql, ***REMOVED***, and sqlite. In theory,
    ...
    if dialect_name == '***REMOVED***':
        url = _set_url_database(url, database="***REMOVED***")
    ...
    if (dialect_name == 'mssql' and dialect_driver in {'pymssql', 'pyodbc'}) \
            or (dialect_name == '***REMOVED***' and dialect_driver in {
...
def drop_database(url):
    ...
    and a constructed url are accepted. ::
        ...
        drop_database('***REMOVED***://***REMOVED***@localhost/name')
    ...
    elif dialect_name == '***REMOVED***' and dialect_driver in {
            'asyncpg', 'pg8000', 'psycopg2', 'psycopg2cffi'}:
        engine = sa.create_engine(url, isolation_level='AUTOCOMMIT')
    else:
        engine = sa.create_engine(url)
