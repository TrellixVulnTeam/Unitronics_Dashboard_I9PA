...
class AirflowConfigParser(ConfigParser):
    ...
    def validate(self):
        ...
        self._upgrade_***REMOVED***_metastore_conn()
    ...
    def _upgrade_***REMOVED***_metastore_conn(self):
        """
        As of SQLAlchemy 1.4, schemes `***REMOVED***+psycopg2` and `***REMOVED***`
        must be replaced with `***REMOVED***`.
        """
        section, key = 'database', 'sql_alchemy_conn'
        old_value = self.get(section, key)
        bad_schemes = ['***REMOVED***+psycopg2', '***REMOVED***']
        good_scheme = '***REMOVED***'
