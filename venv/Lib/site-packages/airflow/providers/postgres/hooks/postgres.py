...
class PostgresHook(DbApiHook):
    ...
    conn_name_attr = '***REMOVED***_conn_id'
    default_conn_name = '***REMOVED***_default'
    conn_type = '***REMOVED***'
    hook_name = 'Postgres'
    ...
    def get_conn(self) -> connection:
        """Establishes a connection to a ***REMOVED*** database."""
    ...
    def get_uri(self) -> str:
        ...
        """
        uri = super().get_uri().replace("***REMOVED***://", "***REMOVED***://")
        return uri
