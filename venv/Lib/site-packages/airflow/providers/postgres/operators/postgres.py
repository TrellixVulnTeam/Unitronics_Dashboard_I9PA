...
from airflow.providers.***REMOVED***.hooks.***REMOVED*** import PostgresHook
...
class PostgresOperator(BaseOperator):
    ...
    :param ***REMOVED***_conn_id: The :ref:`***REMOVED*** conn id <howto/connection:***REMOVED***>`
        reference to a specific ***REMOVED*** database.
    ...
    template_fields_renderers = {
        'sql': '***REMOVED***' if '***REMOVED***' in wwwutils.get_attr_renderer() else 'sql'
    }
    ...
    def __init__(
        ...
        ***REMOVED***_conn_id: str = '***REMOVED***_default',
        ...
        **kwargs,
        ...
        self.sql = sql
        self.***REMOVED***_conn_id = ***REMOVED***_conn_id
    ...
    def execute(self, context: 'Context'):
        self.hook = PostgresHook(***REMOVED***_conn_id=self.***REMOVED***_conn_id, schema=self.database)
