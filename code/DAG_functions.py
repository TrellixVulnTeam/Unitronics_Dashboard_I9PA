...
def transformDeviceData(device_df):
    ...
    prepares the dataframe to merge with the ***REMOVED*** database
...
def transformData(device_df, sensor_df, alarm_df):
    ...
    Returns:
        DataFrames: Three dataframes now ready to load into ***REMOVED*** database
    """
...
def loadData(device_df, sensor_df, alarm_df):
    """
    ingests dataframes that were transformed into the ***REMOVED*** database
